...
function iOS8ThemeFactory() {
	...
	this.themeFromColors = function(colors) {
		...
		style.buttonStyle.title.font.family("HelveticaNeue-Bold");
		...
		style.textFieldStyle.title.font.family("HelveticaNeue-Bold");
		...
		style.switchStyle.onState.textStyle.font.family("Helvetica-Bold");
		...
		style.switchStyle.offState.textStyle.font.family("Helvetica-Bold");
